      ...
      <Col>
        ...
        >
          ...
          <Card.Body style={{ height: "312px" }}>
            <Card.Title>Brand : {pd?.newarrive.brand}</Card.Title>
            <Card.Text>{pd?.newarrive.title}</Card.Text>
            <Card.Text>{pd?.newarrive.name}</Card.Text>
            <Card.Text>
            ...
            <Card.Text>
              <Card.Text>
                <span style={{ fontWeight: "600" }}>
                  {" "}
                  Price : <del>$23 90</del> {pd?.newarrive.price}
                </span>
              </Card.Text>
              <span style={{ fontWeight: "600" }}>
                Available : {pd?.newarrive.available}
              </span>
            </Card.Text>
          </Card.Body>
        </Card>
